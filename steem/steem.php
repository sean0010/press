...
function steem_plugin( $atts ) {
    ...
    $shortcode_replace_content .= '      <input type="text" class="customPercentInput" maxlength="3">';
    $shortcode_replace_content .= '      <span class="percentSymbol">%</span>';
    $shortcode_replace_content .= '      <div class="addVoteOption"><span class="plusbutton"></span></div>';
    $shortcode_replace_content .= '     </div>';
    $shortcode_replace_content .= '     <div class="voteLoader"></div>';
    $shortcode_replace_content .= '    </div>';
    $shortcode_replace_content .= '   </div>';
    $shortcode_replace_content .= '   <div class="linksContainer"></div>';
    $shortcode_replace_content .= '  </div>';
    $shortcode_replace_content .= '  <div class="replyContainer"></div>';
    $shortcode_replace_content .= '  <div class="replyForm">';
    $shortcode_replace_content .= '   <textarea class="replyInput" placeholder="Comment"></textarea>';
